...
<body>
	...
	<div class="col-md-4 text-right">
		<form action="snackbar_category" class="form-inline" id="perPageNumForm">
		...
		<div class="row" >
			<c:forEach items="${snackbar_category }" var="vo" varStatus="vs">
				<c:if test="${vo.category == '분식' }">
					<div class="col-md-3">
	...
	<div class="container-footer">
		<div style="text-align:right; margin-right:12.5%;" >
			...
			<a href="snackbar_category?page=${pageObject.page }&perPageNum=${pageObject.perPageNum}&key=${pageObject.key}&word=${pageObject.word}" class="btn btn-default">새로고침</a>
		</div>	

		<div style="text-align:center;">
			<pageNav:pageNav listURI="snackbar_category" pageObject="${pageObject }" query="&key=${pageObject.key }&word=${pageObject.word }"/>
		</div>
