...
<body>
	...
	<div class="col-md-4 text-right">
		<form action="category" class="form-inline" id="perPageNumForm">
		...
		<div class="row" >
			<c:forEach items="${category }" var="vo" varStatus="vs">
	...
	<div class="container-footer">
		<div style="text-align:right; margin-right:12.5%;" >
			...
			<a href="category?page=${pageObject.page }&perPageNum=${pageObject.perPageNum}&key=${pageObject.key}&word=${pageObject.word}" class="btn btn-default">새로고침</a>
		</div>	
		
		<div style="text-align:center;">
			<pageNav:pageNav listURI="category" pageObject="${pageObject }" query="&key=${pageObject.key }&word=${pageObject.word }"/>
		</div>
	</div>
</body>
